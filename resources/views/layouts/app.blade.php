...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('/images/poltek.png')}}">
        ...
        <!-- Navigation Bar-->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="logo">
                            ...
                            <a href="index.html" class="logo">
                                <img src="{{ asset('/images/poltek.png')}}" alt="" class="logo-large">
                            </a>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            © 2020 AkbarAlfin<span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i> by Bootstrapmade</span>.
                        </div>
                    </div>
                </div>
            </footer>
